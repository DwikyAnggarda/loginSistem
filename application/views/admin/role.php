...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#exampleRoleModal">Add New Role</a>
            ...
            <form action="<?= base_url('admin/role'); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control" id="role" name="role" placeholder="Role name" autofocus autocomplete="off">
                    </div>
                </div>
